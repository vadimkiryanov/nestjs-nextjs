// Этот модуль предоставляет аутентификацию и авторизацию для пользователей NestJS
...
@Injectable() // Говорит NestJS, что этот класс может быть инжектирован в другие классы в качестве зависимости
